...
export const UNIT_ARCHETYPES: Record<UnitArchetype, UnitArchetypeStats> = {
  scout: {
    archetype: 'scout',
    displayName: 'Scout',
    maxHealth: BALANCE_CONFIG.archetypes.scout.hp * 10, // Scale up for game feel
  ...
  bruiser: {
    archetype: 'bruiser',
    displayName: 'Bruiser',
    maxHealth: BALANCE_CONFIG.archetypes.heavy.hp * 10, // Using heavy stats for bruiser
  ...
  sniper: {
    archetype: 'sniper',
    displayName: 'Sniper',
    maxHealth: BALANCE_CONFIG.archetypes.soldier.hp * 10, // Using soldier stats for sniper
...
export const DAMAGE_VARIANCE_MIN = -2 // Kept as is for game feel
export const DAMAGE_VARIANCE_MAX = 3  // Kept as is for game feel
export const CRIT_MULTIPLIER = BALANCE_CONFIG.combat.critMultiplier
export const POISON_DAMAGE_PER_TURN = 4 // Kept as is for game feel
export const POISON_DURATION_TURNS = 2  // Kept as is for game feel
export const ARMOR_UP_DURATION_TURNS = 1 // Kept as is for game feel
export const ARMOR_UP_DAMAGE_REDUCTION = BALANCE_CONFIG.combat.coverMitigation
export const COVER_MISS_BONUS = BALANCE_CONFIG.combat.coverMitigation * 0.3 // Scaled for balance
